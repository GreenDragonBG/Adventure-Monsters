...
public class Swordman : PlayerController
{
    ...
    public void checkInput()
    {
        ...
        if (Input.GetKey(KeyCode.D) && !EnemyScript.PlayerIsAttacked)
        {
        ...
        else if (Input.GetKey(KeyCode.A)&& !EnemyScript.PlayerIsAttacked)
        {
        ...
        if (Input.GetKeyDown(KeyCode.Space))
        {
            ...
            if (currentJumpCount < JumpCount && isGrounded)  // 0 , 1
            {
